...
export class CrowdfundingToken extends ethereum.SmartContract {
  static bind(address: Address): CrowdfundingToken {
    return new CrowdfundingToken("CrowdfundingToken", address);
  }
